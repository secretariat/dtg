...
(function() {
  ...
  jQuery(function() {
    return $('form').on('click', '#xxx_btn', function(event) {
      var $value;
      $value = $('input[id*=pos_stavka]').last().val() + ";" + $('input[id*=pos_summa]').last().val() + ";" + $('input[id*=nalog_stavka]').last().val() + ";" + $('input[id*=nalog_summa]').last().val() + ";" + $('input[id*=neft_stavka]').last().val() + ";" + $('input[id*=neft_summa]').last().val() + ";" + $('input[id*=nds_stavka]').last().val() + ";" + $('input[id*=nds_summa]').last().val() + ";" + $('select[id*=currency]').last().val();
      return $('input[id*=opis_all]').last().val($value);
    });
  });
  ...
  jQuery(function() {
    return $('form').on('change', $('select[id*=tamrez]'), function(event) {
